...
| --------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| npm 12+         | Run `npm approve-scripts iconify-json-nucleo-arcade`                                                                          |
| pnpm 11+        | Add `iconify-json-nucleo-arcade: true` under `allowBuilds` in `pnpm-workspace.yaml`, or run `pnpm approve-builds`             |
| Yarn 4.14+      | Add `dependenciesMeta.iconify-json-nucleo-arcade.built: true` to `package.json`                                               |
| Bun             | Add `iconify-json-nucleo-arcade` to `trustedDependencies` in `package.json`, or run `bun pm trust iconify-json-nucleo-arcade` |
