...
> Nucleo **core** icons as an [Iconify](https://iconify.design/) icon set.
...
| --------------- | ------------------------------------------------------------------------------------------------------------------------- |
| npm 12+         | Run `npm approve-scripts iconify-json-nucleo-core`                                                                        |
| pnpm 11+        | Add `iconify-json-nucleo-core: true` under `allowBuilds` in `pnpm-workspace.yaml`, or run `pnpm approve-builds`           |
| Yarn 4.14+      | Add `dependenciesMeta.iconify-json-nucleo-core.built: true` to `package.json`                                             |
| Bun             | Add `iconify-json-nucleo-core` to `trustedDependencies` in `package.json`, or run `bun pm trust iconify-json-nucleo-core` |
