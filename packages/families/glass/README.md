...
| --------------- | --------------------------------------------------------------------------------------------------------------------------- |
| npm 12+         | Run `npm approve-scripts iconify-json-nucleo-glass`                                                                         |
| pnpm 11+        | Add `iconify-json-nucleo-glass: true` under `allowBuilds` in `pnpm-workspace.yaml`, or run `pnpm approve-builds`            |
| Yarn 4.14+      | Add `dependenciesMeta.iconify-json-nucleo-glass.built: true` to `package.json`                                              |
| Bun             | Add `iconify-json-nucleo-glass` to `trustedDependencies` in `package.json`, or run `bun pm trust iconify-json-nucleo-glass` |
