...
| --------------- | --------------------------------------------------------------------------------------------------------------------------- |
| npm 12+         | Run `npm approve-scripts iconify-json-nucleo-pixel`                                                                         |
| pnpm 11+        | Add `iconify-json-nucleo-pixel: true` under `allowBuilds` in `pnpm-workspace.yaml`, or run `pnpm approve-builds`            |
| Yarn 4.14+      | Add `dependenciesMeta.iconify-json-nucleo-pixel.built: true` to `package.json`                                              |
| Bun             | Add `iconify-json-nucleo-pixel` to `trustedDependencies` in `package.json`, or run `bun pm trust iconify-json-nucleo-pixel` |
