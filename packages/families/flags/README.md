...
| --------------- | --------------------------------------------------------------------------------------------------------------------------- |
| npm 12+         | Run `npm approve-scripts iconify-json-nucleo-flags`                                                                         |
| pnpm 11+        | Add `iconify-json-nucleo-flags: true` under `allowBuilds` in `pnpm-workspace.yaml`, or run `pnpm approve-builds`            |
| Yarn 4.14+      | Add `dependenciesMeta.iconify-json-nucleo-flags.built: true` to `package.json`                                              |
| Bun             | Add `iconify-json-nucleo-flags` to `trustedDependencies` in `package.json`, or run `bun pm trust iconify-json-nucleo-flags` |
