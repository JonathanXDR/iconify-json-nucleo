...
> Nucleo **isometric** icons as an [Iconify](https://iconify.design/) icon set, prefix `nucleo-isometric`.

The licensed SVG data is not shipped. It is generated on your machine from the official Nucleo packages (`nucleo-isometric`) during install, gated by your `NUCLEO_LICENSE_KEY`.
