...
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| npm 12+         | Run `npm approve-scripts iconify-json-nucleo-isometric`                                                                             |
| pnpm 11+        | Add `iconify-json-nucleo-isometric: true` under `allowBuilds` in `pnpm-workspace.yaml`, or run `pnpm approve-builds`                |
| Yarn 4.14+      | Add `dependenciesMeta.iconify-json-nucleo-isometric.built: true` to `package.json`                                                  |
| Bun             | Add `iconify-json-nucleo-isometric` to `trustedDependencies` in `package.json`, or run `bun pm trust iconify-json-nucleo-isometric` |
