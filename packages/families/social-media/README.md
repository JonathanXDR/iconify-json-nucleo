...
> Nucleo **social-media** icons as an [Iconify](https://iconify.design/) icon set, prefix `nucleo-social-media`.

The licensed SVG data is not shipped. It is generated on your machine from the official Nucleo packages (`nucleo-social-media`) during install, gated by your `NUCLEO_LICENSE_KEY`.
